...
public class UIController : MonoBehaviour {
    ...
    public void FindItemsWithID(string itemID)
    {
        ...
        if (curNode == null)
        {
            Debug.LogError("Error could not find Inventory Item with ID: " + itemID + " in ItemInventario.xml");
            return;
        }
    ...
    class InventoryItem
    {
        ...
        public InventoryItem(XmlNode curItemNode)
        {
            ...
            itemTitle = curItemNode["ItemTitulo"].InnerText;
        ...
        public void UpdateInventoryUI(GameObject inventoryUI)
        {
            ...
            {
                Debug.LogError("Error could not find itemTituloText on inventoryUITransform: " + inventoryUITransform.gameObject.name);
            }
            if (itemDescriptionText == null)
            {
                Debug.LogError("Error could not find itemDescripcionText on inventoryUITransform: " + inventoryUITransform.gameObject.name);
            }
